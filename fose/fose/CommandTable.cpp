...
bool Cmd_GetFOSEVersion_Eval(COMMAND_ARGS_EVAL)
{
	*result = FOSE_VERSION_INTEGER;
	if (IsConsoleMode()) {
		Console_Print("xFOSE version: %d", FOSE_VERSION_INTEGER);
	}
	return true;
}
...
bool Cmd_GetFOSERevision_Eval(COMMAND_ARGS_EVAL)
{
	*result = FOSE_VERSION_INTEGER_MINOR;
	if (IsConsoleMode()) {
		Console_Print("xFOSE revision: %d", FOSE_VERSION_INTEGER_MINOR);
	}
	return true;
}
...
bool Cmd_GetFOSEBeta_Eval(COMMAND_ARGS_EVAL)
{
	*result = FOSE_VERSION_INTEGER_BETA;
	if (IsConsoleMode()) {
		Console_Print("xFOSE beta: %d", FOSE_VERSION_INTEGER_BETA);
	}
	return true;
}
