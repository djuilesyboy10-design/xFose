...
public:
	...
	UInt32 size() const { return m_commands.size(); }
	bool empty() const { return m_commands.empty(); }
	CommandInfo& operator[](UInt32 index) { return m_commands[index]; }
	const CommandInfo& operator[](UInt32 index) const { return m_commands[index]; }
	CommandInfo* begin() { return GetStart(); }
	CommandInfo* end() { return GetEnd(); }
	const CommandInfo* begin() const { return &m_commands[0]; }
	const CommandInfo* end() const { return &m_commands[0] + m_commands.size(); }
