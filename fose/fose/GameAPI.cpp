...
extern const _GetActorValueName GetActorValueName = (_GetActorValueName)0x0005A2370;	// See Cmd_GetActorValue_Eval

#elif FALLOUT_VERSION == 0x01070003
...
extern const _GetActorValueName GetActorValueName = (_GetActorValueName)0x005A2CC0;	// See Cmd_GetActorValue_Eval

#else

// Default to 1.7 addresses for unsupported versions
const _ExtractArgs ExtractArgs = (_ExtractArgs)0x00517950;
const _Fallout_DynamicCast Fallout_DynamicCast = (_Fallout_DynamicCast)0x00C0050A;
